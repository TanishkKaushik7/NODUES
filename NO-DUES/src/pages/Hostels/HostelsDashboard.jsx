...
const HostelDashboard = () => { // CHANGED: Component Name
  ...
  const menuItems = [ // CHANGED: Paths to /hostel/...
    { id: 1, label: 'Dashboard', path: '/hostel/dashboard' },
    { id: 2, label: 'Pending', path: '/hostel/pending' },
    { id: 3, label: 'History', path: '/hostel/history' },
  ];

  const DEPARTMENTS = [
    { id: 1, name: 'Department' },
    { id: 2, name: 'Library' }, 
    { id: 3, name: 'Hostel' }, // Hostel ID is 3
    { id: 4, name: 'Accounts' },
    { id: 5, name: 'Sports' },
    { id: 6, name: 'Exam Cell' }
  ];
  ...
  // CHANGED: Set initial actionDeptId to Hostel's ID (3)
  useEffect(() => {
      if (selectedApplication) {
          const HOSTEL_DEPT_ID = 3; 
          setActionDeptId(HOSTEL_DEPT_ID);
      }
  }, [selectedApplication]);
...
    if (!selectedApplication) return null;
    ...
    const userDepartmentName = user?.department_name || 'Hostel'; // CHANGED: Default name to 'Hostel'
    const HOSTEL_DEPT_ID = 3; // CHANGED: Department ID to 3
                ...
                <div className="space-y-4">
                    ...
                    <button
                        ...
                        onClick={() => handleDepartmentAction(
                            selectedApplication, 
                            HOSTEL_DEPT_ID, // CHANGED: Use fixed ID 3
                            'approve', 
                            actionRemark
                        )}
            ...
            >
                ...
                <motion.div variants={itemVariants}>
                    <h1 className="text-3xl font-extrabold mb-1 text-gray-900">
                        Hostel Review {/* CHANGED: Title */}
                    </h1>
                    <p className="text-gray-600 mb-6">Welcome, {user?.name}. Review and process pending No-Dues applications for Hostel.</p> {/* CHANGED: Subtitle */}
                </motion.div>
...
export default HostelDashboard; // CHANGED: Export Name